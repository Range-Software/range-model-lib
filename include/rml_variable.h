...
typedef enum _RVariableType
{
    ...
    R_VARIABLE_ACOUSTIC_DAMPING_FACTOR,
    R_VARIABLE_ACOUSTIC_IMPEDANCE,
    R_VARIABLE_ACOUSTIC_INTENSITY,
    R_VARIABLE_ACOUSTIC_PARTICLE_VELOCITY,
    R_VARIABLE_ACOUSTIC_PHASE,
    R_VARIABLE_ACOUSTIC_PRESSURE,
    R_VARIABLE_ACOUSTIC_SOUND_PRESSURE_LEVEL,
    ...
    R_VARIABLE_POTENTIAL_IMAGINARY,
