...
class RFileIO
{
    ...
    public:
        ...
        //! Read string value.
        static void readAscii(RFile &inFile, QUuid &uValue);
        //! Read string value.
        static void readBinary(RFile &inFile, QUuid &uValue);
        //! Write string value.
        static void writeAscii(RSaveFile &outFile, const QUuid &uValue, bool addNewLine = true);
        static void writeAscii(RFile &outFile, const QUuid &uValue, bool addNewLine = true);
        //! Write string value.
        static void writeBinary(RSaveFile &outFile, const QUuid &uValue);
        ...
        //! Read RMaterialProperty::Type.
        static void readAscii(RFile &inFile, RMaterialProperty::Type &mpType);
        //! Read RMaterialProperty::Type.
        static void readBinary(RFile &inFile, RMaterialProperty::Type &mpType);
        //! Write RMaterialProperty::Type.
        static void writeAscii(RSaveFile &outFile, const RMaterialProperty::Type &mpType, bool addNewLine = true);
        //! Write RMaterialProperty::Type.
        static void writeBinary(RSaveFile &outFile, const RMaterialProperty::Type &mpType);

        // RMaterial::State

        //! Read RMaterial::State.
        static void readAscii(RFile &inFile, RMaterial::State &state);
        //! Read RMaterial::State.
        static void readBinary(RFile &inFile, RMaterial::State &state);
        //! Write RMaterial::State.
        static void writeAscii(RSaveFile &outFile, const RMaterial::State &state, bool addNewLine = true);
        //! Write RMaterial::State.
        static void writeBinary(RSaveFile &outFile, const RMaterial::State &state);
