...
{                                                              \
    ...
    {                                                          \
        throw RError(RError::Type::ReadFile,R_ERROR_REF,_descStr);  \
    }                                                          \
}
...
{                                                              \
    ...
    {                                                          \
        throw RError(RError::Type::WriteFile,R_ERROR_REF,_descStr); \
    }                                                          \
}
...
void RModelMsh::read (const QString &fileName)
{
    ...
    {
        throw RError(RError::Type::InvalidFileName,R_ERROR_REF, "Unknown extension \"" + QString(ext.toUtf8().constData()) + "\".");
    }
} /* RModelMsh::read */
...
void RModelMsh::readAscii (const QString &fileName)
{
    ...
    if (!dTitleFound)
    {
        throw RError(RError::Type::InvalidFileFormat,R_ERROR_REF, "File is missing \'TITLE\' information.");
    }
    if (!dCommentFound)
    {
        throw RError(RError::Type::InvalidFileFormat,R_ERROR_REF, "File is missing \'COMMENT\' information.");
    }
    if (!dFacesNComputedFound)
    {
        throw RError(RError::Type::InvalidFileFormat,R_ERROR_REF, "File is missing \'FACESNCOMPUTED\' information.");
    }
    if (!dBodiesNComputedFound)
    {
        throw RError(RError::Type::InvalidFileFormat,R_ERROR_REF, "File is missing \'BODIESNCOMPUTED\' information.");
    }
    if (!dNodesFound)
    {
        throw RError(RError::Type::InvalidFileFormat,R_ERROR_REF, "File is missing \'NODES\' information.");
    }
    if (!dBodiesAllFound)
    {
        throw RError(RError::Type::InvalidFileFormat,R_ERROR_REF, "File is missing \'BODIES_A\' information.");
    }
    if (!dFacesAllFound)
    {
        throw RError(RError::Type::InvalidFileFormat,R_ERROR_REF, "File is missing \'FACES_A\' information.");
    }
    if (!dLinesAllFound)
    {
        throw RError(RError::Type::InvalidFileFormat,R_ERROR_REF, "File is missing \'LINES_A\' information.");
    }
    if (!dPointsAllFound)
    {
        throw RError(RError::Type::InvalidFileFormat,R_ERROR_REF, "File is missing \'POINTS_A\' information.");
    }
    if (!dBodiesFound)
    {
        throw RError(RError::Type::InvalidFileFormat,R_ERROR_REF, "File is missing \'BODIES\' information.");
    }
    if (!dFacesFound)
    {
        throw RError(RError::Type::InvalidFileFormat,R_ERROR_REF, "File is missing \'FACES\' information.");
    }
    if (!dLinesFound)
    {
        throw RError(RError::Type::InvalidFileFormat,R_ERROR_REF, "File is missing \'LINES\' information.");
    }
    if (!dPointsFound)
    {
        throw RError(RError::Type::InvalidFileFormat,R_ERROR_REF, "File is missing \'POINTS\' information.");
    }
    ...
    while (true)
    {
        ...
        if (mshFile.getTextStream().status() != QTextStream::Ok)
        {
            ...
            throw RError(RError::Type::ReadFile,R_ERROR_REF,"Failed to read the file.");
        }
    ...
    if (!nodesFound)
    {
        throw RError(RError::Type::InvalidFileFormat,R_ERROR_REF, "File is missing \'nodes\' data.");
    }
    if (!facesNeighborsFound)
    {
        throw RError(RError::Type::InvalidFileFormat,R_ERROR_REF, "File is missing \'faces_neighbors\' data.");
    }
    if (!bodiesNeighborsFound)
    {
        throw RError(RError::Type::InvalidFileFormat,R_ERROR_REF, "File is missing \'bodies_neighbors\' data.");
    }
    if (!bodiesNamesFound)
    {
        throw RError(RError::Type::InvalidFileFormat,R_ERROR_REF, "File is missing \'bodies_names\' data.");
    }
    if (!facesNamesFound)
    {
        throw RError(RError::Type::InvalidFileFormat,R_ERROR_REF, "File is missing \'faces_names\' data.");
    }
    if (!linesNamesFound)
    {
        throw RError(RError::Type::InvalidFileFormat,R_ERROR_REF, "File is missing \'lines_names\' data.");
    }
    if (!pointsNamesFound)
    {
        throw RError(RError::Type::InvalidFileFormat,R_ERROR_REF, "File is missing \'points_names\' data.");
    }
    if (!facesThicknessFound)
    {
        throw RError(RError::Type::InvalidFileFormat,R_ERROR_REF, "File is missing \'faces_thickness\' data.");
    }
    if (!linesCareaFound)
    {
        throw RError(RError::Type::InvalidFileFormat,R_ERROR_REF, "File is missing \'lines_carea\' data.");
    }
    if (!pointsVolumeFound)
    {
        throw RError(RError::Type::InvalidFileFormat,R_ERROR_REF, "File is missing \'points_volume\' data.");
    }
    if (!bodiesAllFound)
    {
        throw RError(RError::Type::InvalidFileFormat,R_ERROR_REF, "File is missing \'bodies_all\' data.");
    }
    if (!facesAllFound)
    {
        throw RError(RError::Type::InvalidFileFormat,R_ERROR_REF, "File is missing \'faces_all\' data.");
    }
    if (!linesAllFound)
    {
        throw RError(RError::Type::InvalidFileFormat,R_ERROR_REF, "File is missing \'lines_all\' data.");
    }
    if (!pointsAllFound)
    {
        throw RError(RError::Type::InvalidFileFormat,R_ERROR_REF, "File is missing \'points_all\' data.");
    }
    if (!bodiesFound)
    {
        throw RError(RError::Type::InvalidFileFormat,R_ERROR_REF, "File is missing \'bodies\' data.");
    }
    if (!facesFound)
    {
        throw RError(RError::Type::InvalidFileFormat,R_ERROR_REF, "File is missing \'faces\' data.");
    }
    if (!linesFound)
    {
        throw RError(RError::Type::InvalidFileFormat,R_ERROR_REF, "File is missing \'lines\' data.");
    }
    if (!pointsFound)
    {
        throw RError(RError::Type::InvalidFileFormat,R_ERROR_REF, "File is missing \'points\' data.");
    }
