...
void RGLDisplayProperties::_init(const RGLDisplayProperties *pDisplayProperties)
{
    if (pDisplayProperties)
    {
        ...
        this->showModelGrid = pDisplayProperties->showModelGrid;
    ...
    , bgGradient(true)
{
    ...
    this->lights[0].setAmbient(QColor::fromRgb(25,25,25));
    this->lights[0].setDiffuse(QColor::fromRgb(223,223,223));
    this->lights[0].setSpecular(QColor::fromRgb(255,255,255));
    ...
    this->lights[1].setAmbient(QColor::fromRgb(25,25,25));
    this->lights[1].setDiffuse(QColor::fromRgb(223,223,223));
    this->lights[1].setSpecular(QColor::fromRgb(255,255,255));
...
bool RGLDisplayProperties::getShowModelGrid(void) const
{
    return this->showModelGrid;
}

void RGLDisplayProperties::setShowModelGrid(bool showModelGrid)
{
    this->showModelGrid = showModelGrid;
}
...
QString RGLDisplayProperties::readAscii(const QString &fileName)
{
    ...
    {
        throw RError(RError::Type::InvalidFileFormat,R_ERROR_REF,"File type of the file \'" + fileName + "\' is not DISPLAY PROPERTIES.");
    }
...
void RGLDisplayProperties::writeAscii(const QString &fileName) const
{
    ...
    RFileIO::writeAscii(file,RFileHeader(R_FILE_TYPE_DISPLAY_PROPERTIES,RGLDisplayProperties::version));
...
void RGLDisplayProperties::writeBinary(const QString &fileName) const
{
    ...
    RFileIO::writeBinary(file,RFileHeader(R_FILE_TYPE_DISPLAY_PROPERTIES,RGLDisplayProperties::version));
