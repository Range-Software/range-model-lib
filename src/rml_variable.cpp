...
const RVariableDesc variableDesc [R_VARIABLE_N_TYPES] =
{
    ...
    { "var-acoustic_absorption_coefficient", "Acoustic absorption coefficient",           "N/A",        1.0,     R_VARIABLE_DATA_DOUBLE,  R_PROBLEM_NONE },
    { "var-acoustic_damping_factor"      , "Acoustic damping factor",                   "1/s",        0.0,     R_VARIABLE_DATA_DOUBLE,  R_PROBLEM_NONE },
    { "var-acoustic_impedance"           , "Acoustic impedance",                        "Pa*s/m",     415.0,   R_VARIABLE_DATA_DOUBLE,  R_PROBLEM_NONE },
    { "var-acoustic_intensity"           , "Acoustic intensity",                        "W/m^2",      0.0,     R_VARIABLE_DATA_DOUBLE,  R_PROBLEM_ACOUSTICS },
    { "var-acoustic_particle_velocitty"  , "Acoustic particle velocity",                "m/s",        0.0,     R_VARIABLE_DATA_DOUBLE,  R_PROBLEM_ACOUSTICS },
    { "var-acoustic_phase"               , "Acoustic phase",                            "Deg",        0.0,     R_VARIABLE_DATA_DOUBLE,  R_PROBLEM_ACOUSTICS },
    { "var-acoustic_pressure"            , "Acoustic pressure",                         "Pa",         0.0,     R_VARIABLE_DATA_DOUBLE,  R_PROBLEM_ACOUSTICS },
    { "var-acoustic_sound_pressure_level", "Sound pressure level",                      "dB",         0.0,     R_VARIABLE_DATA_DOUBLE,  R_PROBLEM_ACOUSTICS },
    { "var-charge_density"               , "Charge density",                            "C/m^3",      0.0,     R_VARIABLE_DATA_DOUBLE,  R_PROBLEM_ELECTROSTATICS },
    ...
    { "var-electric_energy"              , "Electric energy",                           "J/m^3",      0.0,     R_VARIABLE_DATA_DOUBLE,  R_PROBLEM_ELECTROSTATICS },
    ...
    { "var-force"                        , "Force",                                     "N",          0.0,     R_VARIABLE_DATA_DOUBLE,  R_PROBLEM_STRESS | R_PROBLEM_STRESS_MODAL },
    ...
    { "var-joule_heat"                   , "Joule heat",                                "W/m^3",      0.0,     R_VARIABLE_DATA_DOUBLE,  R_PROBLEM_ELECTROSTATICS },
    { "var-magnetic_field"               , "Magnetic field",                            "T",          0.0,     R_VARIABLE_DATA_DOUBLE,  R_PROBLEM_MAGNETOSTATICS },
    ...
    { "var-potential_imaginary"          , "Potential (imaginary part)",                "",           0.0,     R_VARIABLE_DATA_DOUBLE,  R_PROBLEM_ACOUSTICS },
    ...
    { "var-relative_permittivity"        , "Relative permittivity",                     "N/A",        0.0,     R_VARIABLE_DATA_DOUBLE,  R_PROBLEM_NONE },
    ...
    { "var-stress_x"                     , "Normal stress in X direction",              "Pa",         0.0,     R_VARIABLE_DATA_DOUBLE,  R_PROBLEM_STRESS | R_PROBLEM_STRESS_MODAL },
    { "var-stress_y"                     , "Normal stress in Y direction",              "Pa",         0.0,     R_VARIABLE_DATA_DOUBLE,  R_PROBLEM_STRESS | R_PROBLEM_STRESS_MODAL },
    { "var-stress_z"                     , "Normal stress in Z direction",              "Pa",         0.0,     R_VARIABLE_DATA_DOUBLE,  R_PROBLEM_STRESS | R_PROBLEM_STRESS_MODAL },
    { "var-stress_xy"                    , "Shear stress in XY plane",                  "Pa",         0.0,     R_VARIABLE_DATA_DOUBLE,  R_PROBLEM_STRESS | R_PROBLEM_STRESS_MODAL },
    { "var-stress_xz"                    , "Shear stress in XZ plane",                  "Pa",         0.0,     R_VARIABLE_DATA_DOUBLE,  R_PROBLEM_STRESS | R_PROBLEM_STRESS_MODAL },
    { "var-stress_yz"                    , "Shear stress in YZ plane",                  "Pa",         0.0,     R_VARIABLE_DATA_DOUBLE,  R_PROBLEM_STRESS | R_PROBLEM_STRESS_MODAL },
