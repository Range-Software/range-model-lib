...
const RVersion RViewFactorMatrix::version = RVersion(FILE_MAJOR_VERSION,FILE_MINOR_VERSION,FILE_RELEASE_VERSION);
...
QString RViewFactorMatrix::readAscii(const QString &fileName)
{
    ...
    {
        throw RError(RError::Type::InvalidFileFormat,R_ERROR_REF,"File type of the file \'" + fileName + "\' is not VIEW FACTOR MATRIX.");
    }
...
void RViewFactorMatrix::writeAscii(const QString &fileName) const
{
    ...
    RFileIO::writeAscii(file,RFileHeader(R_FILE_TYPE_VIEW_FACTOR_MATRIX,RViewFactorMatrix::version));
...
void RViewFactorMatrix::writeBinary(const QString &fileName) const
{
    ...
    RFileIO::writeBinary(file,RFileHeader(R_FILE_TYPE_VIEW_FACTOR_MATRIX,RViewFactorMatrix::version));
